 ...
 * - cible déclarée plus bas, ou relation circulaire → thunk `many(() => Post)`
 */
import { entity, primary, text, ref, many } from "../src/index.js";

// Author référence Post, qui est déclaré APRÈS → thunk obligatoire.
