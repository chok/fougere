...
export default function App() {
  return (
    <div style={{ fontFamily: 'ui-sans-serif, system-ui, sans-serif', margin: '0 auto', maxWidth: 720, padding: '2rem 1rem', lineHeight: 1.55 }}>
      <header style={{ display: 'flex', gap: '1rem', borderBottom: '1px solid #e5e5e5', paddingBottom: '1rem', marginBottom: '2rem' }}>
        <strong>fougere · react router</strong>
