...
Ses métadonnées de contrat doivent alors être rendues disponibles au consommateur sans
partager son code source. L'outillage de ce flux cross-repo n'est pas encore livré ; le
scénario actuellement vérifié reste la séparation au sein du monorepo.
