...
## Le saut est en loopback, sans exception

Le récepteur écoute `127.0.0.1`, refuse toute autre interface, et plafonne les corps à
1 Mio. Ce refus n'est pas de la prudence : un récepteur lit l'identité de l'appelant sur
le fil et ne la rétablit pas, donc l'écoute en loopback est toute la garantie.
Authentifier le lien ne la remplacerait pas — un secret partagé dit qu'un process a le
droit d'appeler, pas au nom de quel utilisateur il parle. L'identité au niveau de la
Frond est la question ouverte ; tant qu'elle ne l'est pas, les deux moitiés d'un split
vivent sur une même machine.
