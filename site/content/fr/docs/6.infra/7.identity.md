...
0.0.0.0 + FOUGERE_ROOT           démarre, vérifie chaque appel
...
```bash
fougere keys              # une fois par système — écrit .fougere/root.key, imprime FOUGERE_ROOT
...
| | Où | Ce que c'est |
|---|---|---|
| `FOUGERE_ROOT` | chaque Frond qui **répond** | publique — sans risque dans une image ou un manifeste |
