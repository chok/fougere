...
`EntityOrm<Post>` est le jeu de gestes auquel les lignes de Post répondent. C'est un
...
portée reste honnête — `productOrm.client` atteint les produits, pas toute la base — mais le
juge ne tourne pas.
::
