...
moitié de cet appel peut être observée. À défaut, l'adresse par défaut est
`http://127.0.0.1:3000`.

Une app qui n'a jamais installé le paquet répond `Unknown rpc operation 'calls'. It serves
discover.`, et cette adresse est rapportée comme un refus plutôt que comme un silence.
