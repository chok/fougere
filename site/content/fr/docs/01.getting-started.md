...
> --local`) — voir [la CLI](/fr/docs/cli). Ce site (`site/`) et `demos/nuxt-blog` servent
> de références complètes. La structure ci-dessous correspond à l'état actuel. Vous avez
> déjà une app Nuxt ?
