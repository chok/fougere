...
- **Nothing is durable.** Kill the listener's process and the fact is lost. At-least-once
  means putting a real channel *under* the dispatch — a change in the transport, not in
  anything above.
