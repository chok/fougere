...
A field belonging to two constraints carries two entries. Each member contains the whole
group, allowing a consumer in another language to rebuild a compound constraint.
