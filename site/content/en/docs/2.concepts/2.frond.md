...
The scanner recognizes a Frond through these directories, in a directory under `fronds/`.
A second domain is added beside the first, and the first does not move.
