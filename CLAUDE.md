...
packages/
  ...
  core/                @fougere/core          the phases below, and what sits outside them
    ...
    src/boot/            what createApp does with it: bootstrap, HandlerFacade, Emissions, AppLifecycle, binding, seed, remote
    src/dispatch/        what happens per call: Dispatcher, the route registry, the judges and projectors, InFlight
