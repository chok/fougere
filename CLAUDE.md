...
packages/
  ...
  core/                @fougere/core          the phases below, and what sits outside them
    ...
    src/boot/            what createApp does with it: bootstrap, HandlerFacade, Emissions, AppLifecycle, seed, remote
    ...
    src/*.ts             what belongs to no phase: the two published entry points, frond(), the ORM port,
